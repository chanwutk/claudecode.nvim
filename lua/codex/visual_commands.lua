...
---@param normal_handler function
---@param visual_handler function
---@return function
...
function M.get_files_from_visual_selection(visual_data)
  ...
  elseif tree_type == "nvim-tree" then
    require("codex.logger").debug("visual_commands", "Processing nvim-tree visual selection from line", start_pos, "to", end_pos)
